...
CREATE TABLE bank_customer(
 `c_no`    VARCHARACTER(14) NOT NULL PRIMARY KEY,
 `c_name`  VARCHARACTER(20) NOT NULL,
 `c_dist`  INT NOT NULL DEFAULT 0,
 `c_phone` VARCHARACTER(20) UNIQUE KEY, 
 `c_addr`  VARCHARACTER(100) DEFAULT NULL
 );

CREATE TABLE bank_account(
 `a_no`        VARCHARACTER(11) NOT NULL PRIMARY KEY,
 `a_item_dist` VARCHARACTER(2) NOT NULL,
 `a_item_name` VARCHARACTER(20) NOT NULL,
 `a_c_no`      VARCHARACTER(14) NOT NULL, 
 ...
 `t_a_no`     VARCHARACTER(11) NOT NULL,
 `t_dist`     INT  NOT NULL,
...
#실습 2-14
SELECT * FROM bank_transaction WHERE t_a_no LIKE "101-11%" AND t_dist = 2 ORDER BY t_amount DESC;
...
#실습 2-20
SELECT 
COUNT(if(`t_dist`= 1, 1, NULL)) AS 입급건수,
